...
if __name__ == '__main__':
    adjust_date_time("dataset/dataset/test_statuses.csv", "dataset/dataset/test_comments.csv", "dataset/dataset/test_shares.csv",
                     "dataset/dataset/test_reactions.csv")
